        ...
        return Flux.defer(() -> {
            ...
            Flux<ServerSentEvent<String>> tokenStream = chatClient.prompt()
                    .system("""
                            ...
                            Q: "내 경매 현황 알려줘"
                            A:
                            | 경매 ID | 상품명 | 상태 | 마감일 | 현재 최저 입찰가 |
                            |---------|--------|------|--------|----------------|
                            | 12 | 노트북 | ACTIVE | 2일 후 | 750,000원 |
                            | 15 | 아이폰 | READY | 5일 후 | (입찰 없음) |
                            | 9 | 태블릿 | DONE | 3일 전 | — |
                            - ACTIVE 경매 1건에 입찰이 진행 중입니다.
                            - READY 경매는 아직 시작 전으로 입찰이 없습니다.

                            Q: "내 입찰 현황 어때? 1위인 게 있어?"
                            A:
                            | 경매 ID | 상품명 | 내 입찰가 | 현재 최저가 | 1위 여부 |
                            |---------|--------|----------|------------|---------|
                            | 5 | 맥북 | 1,200,000원 | 1,200,000원 | ✅ 1위 |
                            | 8 | 에어팟 | 280,000원 | 250,000원 | ❌ |
                            ...
                            |---------|-----------|-----------|-----------|---------|
                            | 전자기기 | 850,000원 | 310,000원 | 2,350,000원 | 3건 |
                            | 스마트폰 | 980,000원 | 980,000원 | 980,000원 | 1건 |
                            - 전자기기 카테고리 전체 평균 낙찰가는 약 85만원입니다.
                            - 스마트폰 하위 카테고리는 거래 1건으로 시세 참고 시 주의가 필요합니다.
